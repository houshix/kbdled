...
✨ kbdled lets you toggle a keyboard LED in Linux (Scroll Lock, by default) with a dedicated key — even on the login screen, before you've signed in. It works well on generic keyboards.✨
